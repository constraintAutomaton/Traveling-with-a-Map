...
From the analysis of the queries, those derived from templates D1, D4, S1, and S3 (S3 is a template that cannot complete the execution before the timeout) are identified as data-model-selective and, as expected, exhibit a reduction in both the number of \ac{HTTP} requests and the query execution time.
