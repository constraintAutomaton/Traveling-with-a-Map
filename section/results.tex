...
\begin{figure}
    ...
    % General caption
    \caption{
    On the left is a plot showing query execution times, while the figure on the right compares the type index approach against other methods.
...
Queries can require as little as 13\% (S1) of the execution time (7 times faster) of the type index.
...
It shows that, although this percentage remains relatively low for most queries, the shape index tends to yield a higher percentage.
