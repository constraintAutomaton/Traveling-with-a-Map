...
In our context, a query that requests a single data model object is classified as data-model-selective, since in our benchmark the subwebs contain at most three distinct data model objects.
