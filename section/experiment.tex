...
Like Comunica, it is modular and has been utilized in multiple LTQP studies~\cite{Bogaerts2021LinkTW, Taelman2023, eschauzier_quweda_linkqueue_2023, Hanski2024, eschauzier_amw_rcubemetric_2024, tam2024opportunitiesshapebasedoptimizationlink}.
...
Each Solid Pod contains alongside its data, a shape index and separate files for each shape definition.
