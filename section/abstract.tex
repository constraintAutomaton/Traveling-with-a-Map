\begin{abstract}
    ...
    % Conclusion
    This performance gain, without server involvement during querying, makes our approach a good candidate for selective queries in networks of structured, decentralized datasets.

\keywords{Linked data,
Link Traversal Query Processing,
RDF data shape,
Highly decentralized querying,
Data summarisation}
