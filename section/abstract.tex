...
% Object  
We formalize this method as a link pruning mechanism for LTQP and evaluate its impact on social media queries.  
% Findings  
Our results show that shape-based pruning improved query execution time and network usage by up to 7 times, with the trade-off of increased server costs for hosting shape indexes.  
% Conclusion  
