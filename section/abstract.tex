...
% Need  
Decentralized architectures, such as Solid-based ecosystems, offer a promising alternative, but efficient query processing remains a challenge.  
...
\jr{what comes next? What could be the next step on this work?}
