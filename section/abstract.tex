\begin{abstract}
    ...
    % Findings
    Our findings show that shape-based data summarization can reduce the query execution time and network usage of selective traversal queries by up to 7 times in our benchmark, even in networks with missing or less informative shapes.
    % Conclusion
