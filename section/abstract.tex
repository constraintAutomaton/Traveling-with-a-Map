\begin{abstract}
    ...
    This method use RDF data shapes to summarise decentralized RDF datasets with the aim of reducing the search space and data usage of queries by identifying irrelevant data sources during query execution.
    % Object
    ...
    Our findings also indicate that the reduction in the number of HTTP requests is linearly correlated for queries benefiting from the shape index, but non-linearly correlated for queries that are significantly negatively affected by this approach.    % Conclusion
