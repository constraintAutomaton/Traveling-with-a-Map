\begin{abstract}
    ...
    % Conclusion
    This performance gain, without server involvement during querying, makes our approach a good candidate for selective queries in structured, decentralized datasets.
