...
\begin{figure*}
    ...
    The nodes represent \ac{RDF} resources, while the edges represent \acp{IRI} linking one resource to another.
    Each subweb has a shape index that maps shapes, represented by icons, to \ac{RDF} resources by embedding the icon within the node.
