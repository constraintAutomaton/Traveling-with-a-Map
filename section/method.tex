...
\begin{figure}
   \centering
   \includegraphics[width=0.8\textwidth]{figure/dkg.png} % Adjust width as needed
   \caption{
      ...
      The query engine starts its query at subweb 3, and the relevant query resources are identified with a black node.
    }
\end{figure}
