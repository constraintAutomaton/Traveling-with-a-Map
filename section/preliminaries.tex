...
A \emph{data-model object} is defined as a template for to the largest connected subgraph of a KG, where the root is the resource (IRI) being described. 
In this work, we assume that data-model objects are described using shapes, however, they could also be described using vocabularies or other formalisms.
