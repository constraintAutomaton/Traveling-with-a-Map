...
We consider two parts of $Q$~\sepfootnote{sf:sparqlSpecification} the basic graph pattern (BGP) defined in Definition~\ref{def:bgp} and the filter expressions.
