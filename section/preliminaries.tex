...
\sepfootnotecontent{sf:recursiveShape}{
    ...
    inverse triple constraint in ShEx \href{https://shex.io/shex-primer/index.html\#inverse-properties}{https://shex.io/shex-primer/index.html\#inverse-properties}
    and SCHACL Inverse Paths \href{https://www.w3.org/TR/shacl/\#property-path-inverse}{https://www.w3.org/TR/shacl/\#property-path-inverse} to avoid recurse 
