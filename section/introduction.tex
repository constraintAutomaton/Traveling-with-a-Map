...
\begin{itemize}
    ...
    \item[\textbf{H2}] The execution time of a query-shape subsumption algorithm is negligible compare to the query execution.
    ...
    \item[\textbf{H5}] Performance gains can be achieved even in networks with partial shape index coverage, demonstrating that the method provides significant improvements without requiring all network participants to adopt shape indexes.
