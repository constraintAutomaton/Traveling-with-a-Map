...
\begin{enumerate}[label=(\roman*)]
    \item An introduction and formalization of \emph{link pruning} for \ac{LTQP}
    \item A web specification for the \emph{shape index} data summary
    \item A novel shape-based pruning approach for \ac{LTQP} using \ac{RDF} data shapes
    \item A novel network abstractions of \emph{subwebs} and \acp{DKG} for \ac{LTQP},
