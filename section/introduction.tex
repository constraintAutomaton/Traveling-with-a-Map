...
\begin{figure}
   \centering
   \includegraphics[width=0.85\textwidth]{figure/dkg.png}
   \caption{
...
Our contributions are a link pruning approach with shape indexes for LTQP, a novel query-shape subsumption algorithm for assessing data source relevance, and experimental results from a synthetic benchmark.
