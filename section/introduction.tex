...
\end{enumerate}
\rt{I would also consider the shape index spec a contribution here. You indeed coined a high-level sketch of the idea before in another paper (that you correctly cite), but with this work, you make that idea/vision concrete.}
...
\rt{No section numbers are present at all. Are you sure this is correct? In any case, this will make things very annoying for reviewers. So if that's really correct, I would consider enabling visible line numbers in the PDF during the review phase.}
