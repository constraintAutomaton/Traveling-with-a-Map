...
However, within specific \emph{subwebs}, that we define as subsections of the Web controlled by particular data providers, implicit or explicit data organizations with structural properties can emerge, which query engines can leverage.  
...
The key intuition is that publishing explicit shapes is relatively inexpensive for data providers but can be highly beneficial for clients querying decentralized datasets.  
