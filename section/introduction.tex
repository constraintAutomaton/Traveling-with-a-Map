...
This paper presents a link pruning approach with shape indexes, a query-shape subsections algorithm for assessing data source relevance, and experimental results from a synthetic benchmark.
