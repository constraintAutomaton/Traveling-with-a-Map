...
Future work could focus on enhancing query planning in LTQP~\cite{taelman2024towards} with RDF data shapes \jr{Isn't this what this work did? What about supporting more complex SPARQL constructs such as filter, aggregations, etc}, developing and maintaining shape indexes, and exploring the impact of shape-based LTQP optimization on result arrival times~\cite{Acosta2017}.
