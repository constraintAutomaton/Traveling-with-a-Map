...
\ifanonymous
      \author{Anonymous}
    \else
      \author{Bryan-Elliott Tam\affilnum{1}, Joachim Van Herwegen\affilnum{1}, Pieter Colpaert\affilnum{1} and Ruben Taelman\affilnum{1}}
...
\rv{Suggestion to add Ruben Verborgh as co-author, given that the work traces back to an idea and grant that I conceptualized. Suggestion for order: Colpaert, Verborgh, Taelman}
