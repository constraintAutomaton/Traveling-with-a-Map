...
% Two-column line numbers in the OUTER margins (left col -> left, right col ->
% right) so they never land in the narrow gutter and collide with text.
\makeatletter
\newcommand*\@LN@outerlinenumber{%
...
\def\volumeyear{2026}
\def\journalname{Semantic Web journal}
...
\ifreview
  \linenumbers
  \makeatletter\let\makeLineNumber\@LN@outerlinenumber\makeatother
\fi
\runninghead{Tam et al.}
